...
sql="insert into users values("+str(user_id)+",'"+name+"',"+phone_no+",'"+email+"','USER',"+"'"+password+"')"
cur.execute(sql)
sql="insert into plant(user_id,plant_id) values("+str(user_id)+",0)"
cur.execute(sql)
...
<html>
	...
	<body>
		...
		<br><br>
		<A href="http://localhost/project/Home.html"><button id="txt">CONTINUE</button></A>
		</center>	 
	</body>
</html>
''')
